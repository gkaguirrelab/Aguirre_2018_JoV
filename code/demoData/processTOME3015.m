...
%{
    ...
    cameraTranslationDepth = depthFromIrisDiameter( sceneGeometry, 220 );
%}
...
runVideoPipeline( pathParams, ...
    ...
    'translationLB',[-5; -5; 148], ...
    'translationUB',[2.5; 5; 152], ...
    'translationLBp',[-2.5; -2.5; 149], ...
    'translationUBp',[1; 2.5; 151], ...
    'nBADSsearches',4, ...
