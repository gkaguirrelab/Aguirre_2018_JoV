...
outputRay = rayTraceEllipsoids([sceneGeometry.eye.pupil.center(1) 2], deg2rad(46), sceneGeometry.refraction.opticalSystem, figureFlag);
...
for deg = 31:-15:-44
    outputRay = rayTraceEllipsoids([sceneGeometry.eye.pupil.center(1) 2], deg2rad(deg), sceneGeometry.refraction.opticalSystem, figureFlag);
    drawnow
end
