function Aguirre_2018_JoVLocalHook
%
...
%% Say hello
fprintf('* Running Aguirre_2018_JoVLocalHook...');

%% Set preferences

% Find the project directory, add it to the path, save this as a
%  pref, and then make this the current directory
projectDir = fullfile(tbLocateProject('Aguirre_2018_JoV'));
addpath(genpath(projectDir));
setpref('Aguirre_2018_JoV', 'projectDir', projectDir);
